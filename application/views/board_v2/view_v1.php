    ...
    <div class="post-content">
      ...
      <div class="">
        <details>
          ...
          <form action="<?= site_url('board_v2/set_content/' . $board[0]['id'] . '/' . $board[0]['group_id']) ?>" method="post" style="display:inline;">
        ...
        <div class="post-container-answer">
          ...
          <div>
            ...
            <div>
              <details>
                <summary>댓글 달기</summary>
                <form action="<?= site_url('board_v2/set_content/' . $board_item['id'] . '/' . $board_item['group_id']) ?>" method="post" style="display:inline;">
                  <label for="content">댓글</label>
                  <textarea name="content"></textarea><br />
                  <button type="submit">댓글 달기</button>
                </form>
