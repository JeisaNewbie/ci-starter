...
<body>
  <div id="board_area">
      ...
      <?php foreach ($board as $board_item): ?>
        <div>
          <tr>
            ...
            <td width="500">
              <a href="<?php echo "/board/view/" . $board_item['id'] . "/" . $board_item['group_id'] ?>">
    ...
    <div id="write_btn" class="btx_box">
      ...
      {
        echo "<a href=\"/ci-starter/board/index/$j/$i\">$i </a>";
      }
      ?>
...
<script>
  document.getElementById('pageLimitSelector').addEventListener('change', function() {
    ...
    const page = 1;
    window.location.href = `/ci-starter/board/index/${limit}/${page}`;
  });
